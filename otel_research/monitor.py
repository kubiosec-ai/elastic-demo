...
def calculate_cost(response):
    if response.model in ['gpt-4', 'gpt-4-turbo', 'gpt-4-turbo-2024-04-09']:
        cost = response.usage.prompt_tokens * 0.03 + response.usage.completion_tokens * 0.06 / 1000
    elif response.model in ['gpt-4-32k', 'gpt-4-32k-turbo']:
...
# Wrap the openai.ChatCompletion.create method
